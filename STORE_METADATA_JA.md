...
- 複数の敵タイプと攻撃パターン
- ローカルスコアとオンラインランキング
- Google / Apple アカウント連携によるランキング復元
...
- `ui_report_images/title.png`
- `ui_report_images/pause.png`
- `ui_report_images/scoreboard.png`
- `ui_report_images/settings.png`

ストア提出前には、実機または提出対象の release build から、各ストア指定サイズのスクリーンショットを撮り直してください。
...
- アカウント連携: Google Sign-In / Sign in with Apple は任意。
...
- User ID: ゲーム内 player ID、Google / Apple の provider subject ID
